...
<div class="flex h-full">
    ...
    <aside class="w-[260px] bg-white/80 dark:bg-surface-900/80 glass border-r border-slate-200 dark:border-slate-800/60 flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
            ...
            <a href="/dashboard" class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-cyan-600 dark:text-cyan-400">
            ...
            <a href="/websites" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/databases" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/ssl" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/files" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/cron" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/terminal" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/ai" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/services" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/notifications" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
            ...
            <a href="/settings" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white">
        ...
        <div class="border-t border-slate-200 dark:border-slate-800/60 p-4">
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-sm font-bold text-white shrink-0">A</div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-slate-800 dark:text-white truncate">Admin</p>
...
<?php /**PATH /mnt/c/Users/User/Desktop/Project Server Base/NexPanel_First/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>