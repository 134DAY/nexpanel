...
<head>
    ...
    <title>NexPanel — <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<div class="flex h-full">
    ...
    <aside class="w-[260px] bg-white/80 dark:bg-surface-900/80 glass border-r border-slate-200 dark:border-slate-800/60 flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
            ...
            <a href="/dashboard" class="sidebar-item <?php echo e(request()->is('dashboard') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('dashboard') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/websites" class="sidebar-item <?php echo e(request()->is('websites*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('websites*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/databases" class="sidebar-item <?php echo e(request()->is('databases*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('databases*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/ssl" class="sidebar-item <?php echo e(request()->is('ssl*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('ssl*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/files" class="sidebar-item <?php echo e(request()->is('files*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('files*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/cron" class="sidebar-item <?php echo e(request()->is('cron*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('cron*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/terminal" class="sidebar-item <?php echo e(request()->is('terminal*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('terminal*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/ai" class="sidebar-item <?php echo e(request()->is('ai*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('ai*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/services" class="sidebar-item <?php echo e(request()->is('services*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('services*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/notifications" class="sidebar-item <?php echo e(request()->is('notifications*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('notifications*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
            ...
            <a href="/settings" class="sidebar-item <?php echo e(request()->is('settings*') ? 'active' : ''); ?> flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->is('settings*') ? 'text-cyan-600 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'); ?>">
        ...
        <div class="border-t border-slate-200 dark:border-slate-800/60 p-4" x-data="{ showMenu: false }">
            <div class="flex items-center gap-3 relative">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-slate-800 dark:text-white truncate"><?php echo e(Auth::user()->name ?? 'Admin'); ?></p>
                    <p class="text-xs text-slate-400 dark:text-slate-500 truncate"><?php echo e(Auth::user()->email ?? 'admin'); ?></p>
                </div>
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header class="h-[72px] bg-white/60 dark:bg-surface-900/60 glass border-b border-slate-200 dark:border-slate-800/60 flex items-center justify-between px-6 shrink-0">
            <div class="flex items-center gap-4">
                <h1 class="text-xl font-bold text-slate-800 dark:text-white"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                <?php if (! empty(trim($__env->yieldContent('subheader')))): ?>
                    <span class="text-sm text-slate-400 dark:text-slate-500">— <?php echo $__env->yieldContent('subheader'); ?></span>
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <button @click="dark = !dark" class="relative w-14 h-7 rounded-full bg-slate-200 dark:bg-slate-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 dark:focus:ring-offset-surface-900">
                    <div class="absolute top-0.5 left-0.5 w-6 h-6 rounded-full bg-white shadow-md transition-transform duration-300 flex items-center justify-center" :class="dark ? 'translate-x-7' : 'translate-x-0'">
                        <svg x-show="!dark" class="w-3.5 h-3.5 text-amber-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd"/></svg>
                        <svg x-show="dark" class="w-3.5 h-3.5 text-slate-600" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"/></svg>
                    </div>
                </button>
...
<?php /**PATH /mnt/c/Users/User/Desktop/Project Server Base/NexPanel_First/resources/views/layouts/app.blade.php ENDPATH**/ ?>